...
* Peer-reviewed publications (listed by publication year)
    + Caley, P., M. Welvaert, and S. C. Barry. 2019. *Crowd surveillance: estimating citizen science reporting probabilities for insects of biosecurity concern*. [Journal of Pest Science, 1-8](https://link.springer.com/article/10.1007%2Fs10340-019-01115-7).
    + Crocker, E., B. Condon, A. Almsaeed, B. Jarret, C. D. Nelson, A. G. Abbott, D. Main, and M. Staton. 2019. *TreeSnap: A citizen science app connecting tree enthusiasts and forest scientists*. [Plants, People, Planet 0:1–6](https://nph.onlinelibrary.wiley.com/doi/full/10.1002/ppp3.41).
    + Baker, E., M. J. Jeger, J. D. Mumford, and N. Brown. 2018. *Enhancing plant biosecurity with citizen science monitoring: comparing methodologies using reports of acute oak decline*. [Journal of Geographical Systems 21:111–131](https://link.springer.com/article/10.1007%2Fs10109-018-0285-2).
    + Hallet, R. and T. Hallett. 2018. *Citizen science and tree health assessment: how useful are the data?* [Arboriculture & Urban Forestry. 44(6): 236–247](https://www.fs.usda.gov/treesearch/pubs/57408).
    + Lione, G., P. Gonthier, and M. Garbelotto. 2017. *Environmental factors driving the recovery of bay laurels from* Phytophthora ramorum *infections: an application of numerical ecology to citizen science*. [Forests 8(8): 293](https://www.mdpi.com/1999-4907/8/8/293).
...
* Online reports (PDFs)
    ...
    + Crow, P. 2017. *Observatree Explained: a Layperson's Report*. [Forest Research](https://www.observatree.org.uk/wp-content/uploads/2017/10/Final-Laymans-report.pdf). 
    + **Your reports here.**
